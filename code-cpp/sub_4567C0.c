int __cdecl sub_4567C0(int a1, int a2)
{
  int v3; // ebp
  int v4; // ebx
  int v5; // edi
  ...
  *(_BYTE *)(a2 + 1686) = 1;
  ...
  if ( !v3 || (v9 = *(_DWORD *)(v3 + 15056), v9 == -1) )
  {
    ...
    if ( v12 >= 0 )
    {
      if ( v12 <= 1 )
      {
        v13 = 16 - ((unsigned __int8)sub_45DAA0(a2, a2 + 3344) != 0);
      }
      else
      {
        if ( v12 != 2 )
...
LABEL_15:
  ...
  sub_45D5B0(a2 + 3368, a2, *(_DWORD *)(a2 + 3320), v17);
  HumanViewCam(a2, 3);
  sub_464700(*(_DWORD *)(a2 + 1260));
  sub_4635F0(a2);
  result = sub_4638A0(a2, aAiDeath, 4);
  *(_DWORD *)(a1 + 20) = sub_456920;
  return result;
}