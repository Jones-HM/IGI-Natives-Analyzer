void __cdecl sub_40A490(_DWORD *a1, int a2)
{
  int v2; // ebx
  int v3; // edx
  ...
  if ( (v2 & 4) != 0 )
  {
    ...
    else if ( (v2 & 0x40000) != 0 )
    {
      if ( *(float *)(a2 + 476) == 0.0 || *(float *)(a2 + 316) != 0.0 )
      {
        if ( (v2 & 0x100) != 0 )
        {
          if ( (v2 & 0x20) != 0 )
          {
            if ( (v2 & 0x2000) != 0 )
            {
              ...
              a1[4] = 23;
              a1[3] = v17;
              v18 = *(void (__cdecl **)(_DWORD *, int))(a1[1] + 92);
              a1[5] = v18;
              v18(a1, a2);
            }
          }
          else
          {
            ...
            a1[4] = 12;
            a1[3] = v15;
            v16 = *(void (__cdecl **)(_DWORD *, int))(a1[1] + 48);
            a1[5] = v16;
            v16(a1, a2);
          }
        }
        else
        {
          ...
          a1[4] = 15;
          a1[3] = v13;
          v14 = *(void (__cdecl **)(_DWORD *, int))(a1[1] + 60);
          a1[5] = v14;
          v14(a1, a2);
        }
      }
    ...
    else
    {
      ...
      a1[3] = a1[4];
      a1[4] = 6;
      v10 = *(void (__cdecl **)(_DWORD *, int))(v9 + 24);
      a1[5] = v10;
      v10(a1, a2);
    }
  }
