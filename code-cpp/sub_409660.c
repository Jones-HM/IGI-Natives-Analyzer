void __cdecl sub_409660(_DWORD *a1, int a2)
{
  int v2; // edx
  int v3; // edx
  ...
  if ( (v2 & 4) != 0 )
  {
    ...
    else if ( (v2 & 0x40000) != 0 )
    {
      ...
      a1[3] = a1[4];
      a1[4] = 15;
      v10 = *(void (__cdecl **)(_DWORD *, int))(v9 + 60);
      a1[5] = v10;
      v10(a1, a2);
    }
      ...
      if ( (v2 & 0x40) != 0 )
      {
        if ( (v2 & 0x80u) == 0 )
        {
          if ( (v2 & 0x100) != 0 )
          {
            ...
            a1[3] = a1[4];
            a1[4] = 5;
            v18 = *(void (__cdecl **)(_DWORD *, int))(v17 + 20);
            a1[5] = v18;
            v18(a1, a2);
          }
          else if ( (v2 & 0x2000) != 0 )
          {
            ...
            a1[3] = a1[4];
            a1[4] = 26;
            v20 = *(void (__cdecl **)(_DWORD *, int))(v19 + 104);
            a1[5] = v20;
            v20(a1, a2);
          }
        }
        else
        {
          ...
          a1[3] = a1[4];
          a1[4] = 2;
          v16 = *(void (__cdecl **)(_DWORD *, int))(v15 + 8);
          a1[5] = v16;
          v16(a1, a2);
        }
      }
