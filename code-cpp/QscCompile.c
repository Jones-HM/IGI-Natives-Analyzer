void QscCompile(char* qsc_file)
{
  ...
  result = sub_4B5B60(qsc_file);
  if ( result )
  {
    v2 = ResourceLoad(qsc_file, &v4);
    v3 = (_DWORD *)MemoryAlloc(148, 4);
    memset(v3, 0, 0x94u);
    v3[32] = v2;
    v3[33] = v4;
    v3[34] = 0;
    strcpy((char *)v3, qsc_file);
    strcpy(Str1, qsc_file);
    ...
    if ( QvmParse(v5, (int)v3) )
    {
      ...
      return sub_4B7E10("An error occured when compiling file: %s", qsc_file);
    }
