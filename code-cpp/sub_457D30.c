_DWORD *__cdecl sub_457D30(_DWORD *a1, int a2)
{
  _DWORD *result; // eax
  int v3; // ecx
  int v4; // edx
  ...
  int (__cdecl **v26)(_DWORD *, int); // edx
  ...
  if ( (v3 & 4) != 0 )
  {
    ...
    else if ( ((unsigned int)&unk_800000 & v3) != 0 )
    {
      if ( (v3 & 0x20) != 0 )
      {
        ...
        a1[3] = a1[4];
        a1[4] = 4;
        v23 = *(int (__cdecl **)(_DWORD *, int))(v22 + 16);
        a1[5] = v23;
      ...
      else if ( (v3 & 0x40) != 0 )
      {
        ...
        a1[3] = a1[4];
        a1[4] = 5;
        v25 = *(int (__cdecl **)(_DWORD *, int))(v24 + 20);
        a1[5] = v25;
        return (_DWORD *)v25(a1, a2);
      }
      else if ( (v3 & 0x80u) == 0 )
      {
        v26 = (int (__cdecl **)(_DWORD *, int))a1[1];
        a1[3] = a1[4];
        a1[4] = 0;
        v27 = *v26;
        a1[5] = *v26;
    ...
    else
    {
      ...
      {
        a1[4] = 3;
        v21 = *(int (__cdecl **)(_DWORD *, int))(v20 + 12);
      }
      else
      {
        a1[4] = 2;
        v21 = *(int (__cdecl **)(_DWORD *, int))(v20 + 8);
      }
      a1[5] = v21;
