_DWORD *__cdecl sub_457A00(_DWORD *a1, int a2)
{
  _DWORD *result; // eax
  int v3; // ecx
  int v4; // edx
  ...
  int v32; // edx
  int (__cdecl *v33)(_DWORD *, int); // ecx
  int v34; // edx
  int (__cdecl *v35)(_DWORD *, int); // ecx
  ...
  if ( (v3 & 0x200000) != 0 )
  {
    ...
    a1[3] = a1[4];
    a1[4] = 35;
    v21 = *(int (__cdecl **)(_DWORD *, int))(v20 + 140);
    a1[5] = v21;
  ...
  if ( (v3 & 0x8000000) != 0 )
  {
    ...
    a1[3] = a1[4];
    a1[4] = 9;
    v23 = *(int (__cdecl **)(_DWORD *, int))(v22 + 36);
    a1[5] = v23;
    return (_DWORD *)v23(a1, a2);
  }
  if ( (v3 & 0x1000000) != 0 && (v3 & 0x80u) != 0 )
  {
    v24 = a1[1];
    a1[3] = a1[4];
    a1[4] = 17;
    v25 = *(int (__cdecl **)(_DWORD *, int))(v24 + 68);
    a1[5] = v25;
    return (_DWORD *)v25(a1, a2);
  }
  if ( ((unsigned int)&unk_800000 & v3) != 0 && (v3 & 0x80u) != 0 )
  {
    v26 = a1[1];
    a1[3] = a1[4];
    a1[4] = 1;
    v27 = *(int (__cdecl **)(_DWORD *, int))(v26 + 4);
    a1[5] = v27;
  ...
  if ( (v3 & 0x40000) != 0 )
  {
    if ( (v3 & 0x80u) != 0 )
    {
      ...
      a1[3] = a1[4];
      a1[4] = 3;
      v29 = *(int (__cdecl **)(_DWORD *, int))(v28 + 12);
      a1[5] = v29;
  ...
  else if ( (v3 & 0x80u) != 0 )
  {
    ...
    a1[3] = a1[4];
    a1[4] = 2;
    v31 = *(int (__cdecl **)(_DWORD *, int))(v30 + 8);
    a1[5] = v31;
  ...
  if ( (v3 & 0x20) != 0 )
  {
    ...
    a1[3] = a1[4];
    a1[4] = 4;
    v33 = *(int (__cdecl **)(_DWORD *, int))(v32 + 16);
    a1[5] = v33;
    return (_DWORD *)v33(a1, a2);
  }
  else if ( (v3 & 0x40) != 0 )
  {
    v34 = a1[1];
    a1[3] = a1[4];
    a1[4] = 5;
    v35 = *(int (__cdecl **)(_DWORD *, int))(v34 + 20);
    a1[5] = v35;
    return (_DWORD *)v35(a1, a2);
  }
  return result;
}