void __cdecl sub_409090(_DWORD *a1, int a2)
{
  int v2; // edx
  int v3; // edx
  ...
  void (__cdecl **v17)(_DWORD *, int); // edx
  ...
  if ( (v2 & 4) != 0 )
  {
    ...
    else if ( (v2 & 0x40000) != 0 )
    {
      ...
      a1[3] = a1[4];
      a1[4] = 12;
      v10 = *(void (__cdecl **)(_DWORD *, int))(v9 + 48);
      a1[5] = v10;
      v10(a1, a2);
    }
    else if ( *(float *)(a2 + 476) == 0.0 || *(float *)(a2 + 316) != 0.0 )
    {
      if ( (v2 & 0x40) != 0 )
      {
        ...
        a1[3] = a1[4];
        a1[4] = 5;
        v14 = *(void (__cdecl **)(_DWORD *, int))(v13 + 20);
        a1[5] = v14;
        v14(a1, a2);
      }
      else if ( (v2 & 0x20) != 0 )
      {
        ...
        a1[3] = a1[4];
        a1[4] = 6;
        v16 = *(void (__cdecl **)(_DWORD *, int))(v15 + 24);
        a1[5] = v16;
        v16(a1, a2);
      }
      else if ( (v2 & 0x100) != 0 )
      {
        if ( (v2 & 0x2000) != 0 )
        {
          ...
          a1[3] = a1[4];
          a1[4] = 23;
          v20 = *(void (__cdecl **)(_DWORD *, int))(v19 + 92);
          a1[5] = v20;
          v20(a1, a2);
        }
      }
      ...
      {
        v17 = (void (__cdecl **)(_DWORD *, int))a1[1];
        a1[3] = a1[4];
        a1[4] = 0;
        v18 = *v17;
        a1[5] = *v17;
