int (__cdecl *__cdecl sub_43C390(int a1, _DWORD *a2))(int, int *)
{
  float *v2; // eax
  double v3; // st7
  double v4; // st7
  ...
  *(double *)(a1 + 256) = *(double *)(*a2 + 16) + *(double *)(a1 + 256);
  ...
  v5 = a2[1];
  *(float *)v16 = *(float *)(a1 + 352) * *(float *)(v5 + 8)
                + *(float *)(a1 + 328) * *(float *)v5
                + *(float *)(a1 + 340) * *(float *)(v5 + 4);
  *((float *)v16 + 1) = *(float *)(a1 + 356) * *(float *)(v5 + 8)
                      + *(float *)(a1 + 332) * *(float *)v5
                      + *(float *)(a1 + 344) * *(float *)(v5 + 4);
  *(float *)&v16[1] = *(float *)(a1 + 360) * *(float *)(v5 + 8)
                    + *(float *)(a1 + 336) * *(float *)v5
                    + *(float *)(a1 + 348) * *(float *)(v5 + 4);
  *((float *)&v16[1] + 1) = *(float *)(a1 + 340) * *(float *)(v5 + 16)
                          + *(float *)(v5 + 20) * *(float *)(a1 + 352)
                          + *(float *)(v5 + 12) * *(float *)(a1 + 328);
  *(float *)&v16[2] = *(float *)(a1 + 344) * *(float *)(v5 + 16)
                    + *(float *)(v5 + 20) * *(float *)(a1 + 356)
                    + *(float *)(v5 + 12) * *(float *)(a1 + 332);
  *((float *)&v16[2] + 1) = *(float *)(a1 + 348) * *(float *)(v5 + 16)
                          + *(float *)(v5 + 20) * *(float *)(a1 + 360)
                          + *(float *)(v5 + 12) * *(float *)(a1 + 336);
  v6 = *(_DWORD *)(v5 + 36);
  *(float *)&v16[3] = *(float *)(a1 + 340) * *(float *)(v5 + 28)
                    + *(float *)(v5 + 32) * *(float *)(a1 + 352)
                    + *(float *)(v5 + 24) * *(float *)(a1 + 328);
  *((float *)&v16[3] + 1) = *(float *)(a1 + 344) * *(float *)(v5 + 28)
                          + *(float *)(v5 + 32) * *(float *)(a1 + 356)
                          + *(float *)(v5 + 24) * *(float *)(a1 + 332);
  v7 = *(float *)(a1 + 348) * *(float *)(v5 + 28)
     + *(float *)(v5 + 32) * *(float *)(a1 + 360)
