void __cdecl sub_40A870(_DWORD *a1, int a2)
{
  int v2; // ebx
  int v3; // edx
  ...
  if ( (v2 & 4) != 0 )
  {
        ...
        if ( (v2 & 0x20) != 0 )
        {
          if ( (v2 & 0x80u) == 0 )
          {
            if ( (v2 & 0x100) != 0 )
            {
              ...
              a1[4] = 14;
              a1[3] = v17;
              v18 = *(void (__cdecl **)(_DWORD *, int))(a1[1] + 56);
              a1[5] = v18;
              v18(a1, a2);
            }
            else if ( (v2 & 0x2000) != 0 )
            {
              ...
              a1[4] = 27;
              a1[3] = v19;
              v20 = *(void (__cdecl **)(_DWORD *, int))(a1[1] + 108);
              a1[5] = v20;
              v20(a1, a2);
            }
          }
          else
          {
            ...
            a1[4] = 11;
            a1[3] = v15;
            v16 = *(void (__cdecl **)(_DWORD *, int))(a1[1] + 44);
            a1[5] = v16;
            v16(a1, a2);
          }
        }
    ...
    else
    {
      ...
      a1[3] = a1[4];
      a1[4] = 8;
      v10 = *(void (__cdecl **)(_DWORD *, int))(v9 + 32);
      a1[5] = v10;
      v10(a1, a2);
    }
  }
