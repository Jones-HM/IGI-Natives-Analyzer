...
fstp    dword ptr [esi]
mov     edx, [ebp+2F4h]
fadd    dword ptr [ebp+0D08h]
mov     [esp+5Ch+C], edx
fst     dword ptr [ebp+0D08h]
fld     dword ptr [esi]
fcomp   dword ptr [esi+4]
fnstsw  ax
test    ah, 1
jz      short loc_4558E3
fcomp   dword ptr [ebp+0D04h]
fnstsw  ax
test    ah, 41h
jnz     short loc_4558CD
mov     dword ptr [ebp+0D08h], 0
push    3
...
mov     edx, [esp+68h+C]
add     esp, 0Ch
jmp     short loc_45590D
lea     edi, [ebp+0D20h]
mov     ecx, 6
lea     esi, [esp+5Ch+var_4C]
mov     dword ptr [ebp+0D18h], 2
fstp    st
rep movsd
or      edx, 20000h
