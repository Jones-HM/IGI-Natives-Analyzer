...
fnstsw  ax
test    ah, 41h
jnz     short loc_4CC40B
mov     eax, [ebx+8]
mov     ecx, [ebx+0Ch]
mov     dword ptr [ebp+var_30], eax
mov     dword ptr [ebp+var_30+4], ecx
jmp     short loc_4CC424
fld     qword ptr [ebx+8]
fcomp   [ebp+var_18]
fnstsw  ax
test    ah, 1
